...
Item {
    ...
    property color color: QuiColor.Button
    ...
    Rectangle {
        ...
        visible: false
        border.color: QuiColor.ButtonShadow
    }
    Rectangle {
        id: rect_border
        anchors.fill: parent
        ...
        gradient: Gradient {
            ...
            GradientStop { position: control.height > 0 ? Math.max(0.0, 1.0 - 3.0 / control.height) : 0.0; color: d.startColor }
