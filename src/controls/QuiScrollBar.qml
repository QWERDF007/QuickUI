...
T.ScrollBar {
    ...
    property color color : QuiColor.ScrollBar
    property color bgColor: QuiColor.ScrollBarBackground
    ...
    QuiTextIconButton{
        ...
        iconSource: QuiFontIcon.CaretLeftSolid8
        onClicked: {
            control.decrease()
        }
    }
    QuiTextIconButton{
        ...
        visible: control.horizontal
        iconSource: QuiFontIcon.CaretRightSolid8
        onClicked: {
            control.increase()
        }
    }
    QuiTextIconButton{
        ...
        iconSource: QuiFontIcon.CaretUpSolid8
        onClicked: {
            control.decrease()
        }
    }
    QuiTextIconButton{
        ...
        visible: control.vertical
        iconSource: QuiFontIcon.CaretDownSolid8
        onClicked: {
            control.increase()
        }
    }
